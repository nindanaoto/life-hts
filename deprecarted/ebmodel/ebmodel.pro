...
FunctionSpace {
  ...
  { Name BSpace ; Type Form1;
    BasisFunction {
      { Name bse; NameOfCoef be; Function BF_Edge;
  ...
  { Name XSpace ; Type Form1;
    BasisFunction {
      { Name xse; NameOfCoef xe; Function BF_Edge;
        Support MagnAnhyDomain; Entity EdgesOf[MagnAnhyDomain]; }
      // { Name sex ; NameOfCoef aex ; Function BF_VolumeX ; Support MagnAnhyDomain ; Entity VolumesOf[All, Not BndOmegaC] ; }
      // { Name sey ; NameOfCoef aey ; Function BF_VolumeY ; Support MagnAnhyDomain ; Entity VolumesOf[All, Not BndOmegaC] ; }
      // { Name sez ; NameOfCoef aez ; Function BF_VolumeZ ; Support MagnAnhyDomain ; Entity VolumesOf[All, Not BndOmegaC] ; }
    }
...
Formulation {
  { Name MagDynH; Type FemEquation;
    Quantity {
      ...
      { Name x; Type Local; NameOfSpace XSpace; }//Previous step's X
    ...
    Equation {
      ...
      Galerkin { [ -SetVariable[b_EB[{h},{x}[1]]{List[hyst_EB]},QuadraturePointIndex[]]{$bEB} , {b} ]  ;
        In MagnAnhyDomain ; Jacobian Vol ; Integration Int; }
      Galerkin { [ Dof{x}   , {x} ]  ; // saving h_Jiles in local quantity h
        In MagnAnhyDomain ; Jacobian Vol ; Integration Int; }
      Galerkin { [ -Cell_EB[1, {h},{x}]{List[hyst_EB]} , {x} ]  ;
        In MagnAnhyDomain ; Jacobian Vol ; Integration Int; }
      
      Galerkin { [( GetVariable[QuadraturePointIndex[]]{$bEB} / $DTime) , {h} ];
        In MagnAnhyDomain; Integration Int; Jacobian Vol;  }
      Galerkin { [ -{b}[1] / $DTime , {h} ];
        In MagnAnhyDomain; Integration Int; Jacobian Vol;  }
      Galerkin { JacNL[ $RelaxFac*dbdh_EB[{h},{x}]{List[hyst_EB]} * Dof{h} / $DTime , {h}];
        In MagnAnhyDomain; Integration Int; Jacobian Vol;  }
