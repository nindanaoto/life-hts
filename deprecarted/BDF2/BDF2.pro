...
Formulation {
  { Name MagDynH; Type FemEquation;
    ...
    Equation {
      ...
      //
      Galerkin { [ 3/2*mu[] * Dof{h} / $DTime , {h} ];
        In MagnLinDomain; Integration Int; Jacobian Vol;  }
      Galerkin { [ - 2* mu[] * {h}[1] / $DTime , {h} ];
        In MagnLinDomain; Integration Int; Jacobian Vol;  }
      Galerkin { [ 1/2 * mu[] * {h}[2] / $DTime , {h} ];
        In MagnLinDomain; Integration Int; Jacobian Vol;  }
      
      Galerkin { [ 3/2*mu[{h}] * {h} / $DTime , {h} ];
        In MagnAnhyDomain; Integration Int; Jacobian Vol;  }
      Galerkin { JacNL[dbdh[{h}] * Dof{h} / $DTime , {h}];
        In MagnAnhyDomain; Integration Int; Jacobian Vol;  }
      Galerkin { [ - 2* mu[{h}[1]] * {h}[1] / $DTime , {h} ];
        In MagnAnhyDomain; Integration Int; Jacobian Vol;  }
      Galerkin { [ 1/2 * mu[{h}[2]] * {h}[2] / $DTime , {h} ];
        In MagnAnhyDomain; Integration Int; Jacobian Vol;  }
