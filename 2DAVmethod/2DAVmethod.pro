...
Function {
  ...
  DefineConstant[
    ...
    dt = {2e-5, Min 1e-7, Max 1e-3, Step 1e-6,
...
Constraint {
  ...
  { Name Current ;
    Case {
      { Region Omega; Value -Itot ; TimeFunction Sin_wt_p[]{2*Pi*Freq, 0.} ; }
    }
  }
  { Name a ;
    Case {
...
Formulation {
  { Name MagDynA; Type FemEquation;
    Quantity {
      ...
      { Name U; Type Global; NameOfSpace GradVSpace [U]; }
    }
    Equation {
