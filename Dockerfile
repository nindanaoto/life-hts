...
RUN git checkout cceab80e16f5b696f049285dd756858c4150f98b && mkdir bin && cd bin && cmake -DENABLE_MPI=1 -DENABLE_BLAS_LAPACK=0 .. && make && mv getdp /onelab-Linux64/
...
CMD cd src && ../gmsh -2 relaxation.geo && ../getdp relaxation.pro -solve MagDynHTime && ../getdp relaxation.pro -pos MagDynH